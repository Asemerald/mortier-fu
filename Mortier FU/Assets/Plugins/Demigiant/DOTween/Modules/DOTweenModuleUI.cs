...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        /// <summary>
        /// Tweens an Animator's layer weight to the given value
        /// </summary>
        /// <param name="target">The target Animator</param>
        /// <param name="layerIndex">Index of the layer to tween</param>
        /// <param name="endValue">The end value to reach (0f to 1f)</param>
        /// <param name="duration">The duration of the tween</param>
        /// <param name="snapping">If TRUE the tween will smoothly snap all values to integers</param>
        public static TweenerCore<float, float, FloatOptions> DOLayerWeight(this Animator target, int layerIndex, float endValue, float duration, bool snapping = false)
        {
            TweenerCore<float, float, FloatOptions> t = DOTween.To(
                () => target.GetLayerWeight(layerIndex), 
                x => target.SetLayerWeight(layerIndex, x),
                endValue, 
                duration
            );
