...
namespace MortierFu
{
    public sealed class LobbyMatchLauncher : MonoBehaviour
    {
        ...
        [SerializeField] private TEMP_LobbyConfirmMatchController _LobbyConfirmMatchController; //stoian
        ...
        public void LaunchMatch(PlayerManager player) //stoian
        {
            _LobbyConfirmMatchController.TryOpenConfirmation(player); //Stoian
        }
