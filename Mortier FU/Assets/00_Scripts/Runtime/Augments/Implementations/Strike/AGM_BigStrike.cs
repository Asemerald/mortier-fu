namespace MortierFu.Stats
{
    public class AGM_BigStrike : AugmentBase
    {
        ...
        {
            stats.StrikeStunDuration.AddModifier(new StatModifier(0.2f, E_StatModType.PercentAdd, this));
            stats.StrikeCooldown.AddModifier(new StatModifier(0.5f, E_StatModType.PercentAdd, this));
        }
